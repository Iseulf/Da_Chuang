package com.example.da_chuang.libsvm;
...
class Solver {
    ...
    void Solve(int l, QMatrix Q, double[] p_, byte[] y_,
        ...
        int iter = 0;
        int max_iter = Math.max(10000000, l > Integer.MAX_VALUE / 100 ? Integer.MAX_VALUE :
                100 * l);
...
public class svm {
    ...
    private static void svm_binary_svc_probability(svm_problem prob, svm_parameter param,
    ...
    private static double svm_svr_probability(svm_problem prob, svm_parameter param) {
        ...
        svm.info("Prob. model for test data: target value = predicted value + z,\nz: Laplace " +
                "distribution e^(-|z|/sigma)/(2sigma),sigma=" + mae + "\n");
        return mae;
    }
    ...
    public static void svm_save_model(String model_file_name, svm_model model) throws IOException {
        DataOutputStream fp =
                new DataOutputStream(new BufferedOutputStream(new FileOutputStream(new File(model_file_name))));
    ...
    private static boolean read_model_header(BufferedReader fp, svm_model model) {
        ...
        model.param = param;
        // parameters for training only won't be assigned, but arrays are assigned as null for
        // safety
        param.nr_weight = 0;
