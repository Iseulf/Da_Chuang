...
public class svm_predict {
    private static final svm_print_interface svm_print_null = new svm_print_interface() {
    ...
    private static void predict(BufferedReader input, DataOutputStream output, svm_model model,
    ...
    public static void SVM_PREDICT(String[] argv) throws IOException {
        //程序调用入口
        ...
        try {
            ...
            if (predict_probability == 1) {
                ...
                if (svm.svm_check_probability_model(model) != 0) {
                    svm_predict.info("Model supports probability estimates, but disabled in " +
                            "prediction.\n");
                }
            }
